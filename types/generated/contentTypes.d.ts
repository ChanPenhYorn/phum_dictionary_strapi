...
export interface ApiDefinitionDefinition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    antonyms: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    example: Schema.Attribute.RichText;
    ...
    > &
      Schema.Attribute.Private;
    partOfSpeech: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    synonyms: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDictionaryDictionary extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    alphabet: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    definitions: Schema.Attribute.Relation<
      'oneToMany',
      'api::definition.definition'
    >;
    dictionaryComp: Schema.Attribute.Component<
      'dictionary-comps.definition-comp',
      true
    >;
    ...
    > &
      Schema.Attribute.Private;
    mainLanguage: Schema.Attribute.Relation<
      'oneToOne',
